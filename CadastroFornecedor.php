...
include_once 'c:/xampp/htdocs/PhpMatutinoPDO/controller/FornecedorController.php';
...
<html lang="pt-br">
    ...
    <body> 
        ...
        <div class="container-fluid">
                    ...
                    <div class="card-body border">
                        ...
                        if (isset($_POST['cadastrarFornecedor'])) {
                            ...
                            if ($nomeFornecedor != "") {
                                ...
                                $msg = $fc->inserirFornecedor($nomeFornecedor, $logradouro, $numero,
            ...
            $nomeFornecedor, $logradouro, $numero,$complemento, $bairro, $cidade,
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="number" 
                                           value="<?php echo $f->getNumero(); ?>" name="numero"> 
